...
#### `/format-learning-note` コマンド

学習メモファイルの見出し構造を整理するコマンドです。複数の質問と回答が追加された際に、見出しレベルを統一して読みやすくします。

1. 学習メモファイル（`*_learning/*.md`）を開く
2. `/format-learning-note` コマンドを実行
3. 見出し構造が自動的に整理される

**整理される内容:**
- 見出しレベルの統一（h1: タイトル、h2: 質問/回答、h3: サブセクション）
- 質問と回答のペア化
- 区切り線の追加
- 参考リンクの最後への配置
